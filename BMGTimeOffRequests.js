(function () {
    ...
    // ✅ Substituição do .show() por open = true
    document.body.appendChild(dialog);
    dialog.open = true;

    // fallback caso o servidor esteja indisponível
    ...
    // load SSO script if not already present
